...
class stl_vector_owlmarker(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self):
        """iterator(stl_vector_owlmarker self) -> SwigPyIterator"""
        return _OWL.stl_vector_owlmarker_iterator(self)

    def __iter__(self): return self.iterator()
    def __nonzero__(self):
        """__nonzero__(stl_vector_owlmarker self) -> bool"""
        return _OWL.stl_vector_owlmarker___nonzero__(self)

    def __bool__(self):
        """__bool__(stl_vector_owlmarker self) -> bool"""
        return _OWL.stl_vector_owlmarker___bool__(self)

    def __len__(self):
        """__len__(stl_vector_owlmarker self) -> std::vector< OWLMarker >::size_type"""
        return _OWL.stl_vector_owlmarker___len__(self)

    def pop(self):
        """pop(stl_vector_owlmarker self) -> OWLMarker"""
        return _OWL.stl_vector_owlmarker_pop(self)

    def __getslice__(self, *args):
        """__getslice__(stl_vector_owlmarker self, std::vector< OWLMarker >::difference_type i, std::vector< OWLMarker >::difference_type j) -> stl_vector_owlmarker"""
        return _OWL.stl_vector_owlmarker___getslice__(self, *args)

    def __setslice__(self, *args):
        """
        __setslice__(stl_vector_owlmarker self, std::vector< OWLMarker >::difference_type i, std::vector< OWLMarker >::difference_type j, 
            stl_vector_owlmarker v=std::vector< OWLMarker,std::allocator< OWLMarker > >())
        __setslice__(stl_vector_owlmarker self, std::vector< OWLMarker >::difference_type i, std::vector< OWLMarker >::difference_type j)
        """
        return _OWL.stl_vector_owlmarker___setslice__(self, *args)

    def __delslice__(self, *args):
        """__delslice__(stl_vector_owlmarker self, std::vector< OWLMarker >::difference_type i, std::vector< OWLMarker >::difference_type j)"""
        return _OWL.stl_vector_owlmarker___delslice__(self, *args)

    def __delitem__(self, *args):
        """
        __delitem__(stl_vector_owlmarker self, std::vector< OWLMarker >::difference_type i)
        __delitem__(stl_vector_owlmarker self, PySliceObject * slice)
        """
        return _OWL.stl_vector_owlmarker___delitem__(self, *args)

    def __getitem__(self, *args):
        """
        __getitem__(stl_vector_owlmarker self, PySliceObject * slice) -> stl_vector_owlmarker
        __getitem__(stl_vector_owlmarker self, std::vector< OWLMarker >::difference_type i) -> OWLMarker
        """
        return _OWL.stl_vector_owlmarker___getitem__(self, *args)

    def __setitem__(self, *args):
        """
        __setitem__(stl_vector_owlmarker self, PySliceObject * slice, stl_vector_owlmarker v)
        __setitem__(stl_vector_owlmarker self, PySliceObject * slice)
        __setitem__(stl_vector_owlmarker self, std::vector< OWLMarker >::difference_type i, OWLMarker x)
        """
        return _OWL.stl_vector_owlmarker___setitem__(self, *args)

    def append(self, *args):
        """append(stl_vector_owlmarker self, OWLMarker x)"""
        return _OWL.stl_vector_owlmarker_append(self, *args)

    def empty(self):
        """empty(stl_vector_owlmarker self) -> bool"""
        return _OWL.stl_vector_owlmarker_empty(self)

    def size(self):
        """size(stl_vector_owlmarker self) -> std::vector< OWLMarker >::size_type"""
        return _OWL.stl_vector_owlmarker_size(self)

    def clear(self):
        """clear(stl_vector_owlmarker self)"""
        return _OWL.stl_vector_owlmarker_clear(self)

    def swap(self, *args):
        """swap(stl_vector_owlmarker self, stl_vector_owlmarker v)"""
        return _OWL.stl_vector_owlmarker_swap(self, *args)

    def get_allocator(self):
        """get_allocator(stl_vector_owlmarker self) -> std::vector< OWLMarker >::allocator_type"""
        return _OWL.stl_vector_owlmarker_get_allocator(self)

    def begin(self):
        """begin(stl_vector_owlmarker self) -> std::vector< OWLMarker >::iterator"""
        return _OWL.stl_vector_owlmarker_begin(self)

    def end(self):
        """end(stl_vector_owlmarker self) -> std::vector< OWLMarker >::iterator"""
        return _OWL.stl_vector_owlmarker_end(self)

    def rbegin(self):
        """rbegin(stl_vector_owlmarker self) -> std::vector< OWLMarker >::reverse_iterator"""
        return _OWL.stl_vector_owlmarker_rbegin(self)

    def rend(self):
        """rend(stl_vector_owlmarker self) -> std::vector< OWLMarker >::reverse_iterator"""
        return _OWL.stl_vector_owlmarker_rend(self)

    def pop_back(self):
        """pop_back(stl_vector_owlmarker self)"""
        return _OWL.stl_vector_owlmarker_pop_back(self)

    def erase(self, *args):
        """
        erase(stl_vector_owlmarker self, std::vector< OWLMarker >::iterator pos) -> std::vector< OWLMarker >::iterator
        erase(stl_vector_owlmarker self, std::vector< OWLMarker >::iterator first, std::vector< OWLMarker >::iterator last) -> std::vector< OWLMarker >::iterator
        """
        return _OWL.stl_vector_owlmarker_erase(self, *args)

    def __init__(self, *args): 
        """
        __init__(std::vector<(OWLMarker)> self) -> stl_vector_owlmarker
        __init__(std::vector<(OWLMarker)> self, stl_vector_owlmarker arg2) -> stl_vector_owlmarker
        __init__(std::vector<(OWLMarker)> self, std::vector< OWLMarker >::size_type size) -> stl_vector_owlmarker
        __init__(std::vector<(OWLMarker)> self, std::vector< OWLMarker >::size_type size, OWLMarker value) -> stl_vector_owlmarker
        """
        this = _OWL.new_stl_vector_owlmarker(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args):
        """push_back(stl_vector_owlmarker self, OWLMarker x)"""
        return _OWL.stl_vector_owlmarker_push_back(self, *args)

    def front(self):
        """front(stl_vector_owlmarker self) -> OWLMarker"""
        return _OWL.stl_vector_owlmarker_front(self)

    def back(self):
        """back(stl_vector_owlmarker self) -> OWLMarker"""
        return _OWL.stl_vector_owlmarker_back(self)

    def assign(self, *args):
        """assign(stl_vector_owlmarker self, std::vector< OWLMarker >::size_type n, OWLMarker x)"""
        return _OWL.stl_vector_owlmarker_assign(self, *args)

    def resize(self, *args):
        """
        resize(stl_vector_owlmarker self, std::vector< OWLMarker >::size_type new_size)
        resize(stl_vector_owlmarker self, std::vector< OWLMarker >::size_type new_size, OWLMarker x)
        """
        return _OWL.stl_vector_owlmarker_resize(self, *args)

    def insert(self, *args):
        """
        insert(stl_vector_owlmarker self, std::vector< OWLMarker >::iterator pos, OWLMarker x) -> std::vector< OWLMarker >::iterator
        insert(stl_vector_owlmarker self, std::vector< OWLMarker >::iterator pos, std::vector< OWLMarker >::size_type n, OWLMarker x)
        """
        return _OWL.stl_vector_owlmarker_insert(self, *args)

    def reserve(self, *args):
        """reserve(stl_vector_owlmarker self, std::vector< OWLMarker >::size_type n)"""
        return _OWL.stl_vector_owlmarker_reserve(self, *args)

    def capacity(self):
        """capacity(stl_vector_owlmarker self) -> std::vector< OWLMarker >::size_type"""
...
class stl_vector_owlrigid(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self):
        """iterator(stl_vector_owlrigid self) -> SwigPyIterator"""
        return _OWL.stl_vector_owlrigid_iterator(self)

    def __iter__(self): return self.iterator()
    def __nonzero__(self):
        """__nonzero__(stl_vector_owlrigid self) -> bool"""
        return _OWL.stl_vector_owlrigid___nonzero__(self)

    def __bool__(self):
        """__bool__(stl_vector_owlrigid self) -> bool"""
        return _OWL.stl_vector_owlrigid___bool__(self)

    def __len__(self):
        """__len__(stl_vector_owlrigid self) -> std::vector< OWLRigid >::size_type"""
        return _OWL.stl_vector_owlrigid___len__(self)

    def pop(self):
        """pop(stl_vector_owlrigid self) -> OWLRigid"""
        return _OWL.stl_vector_owlrigid_pop(self)

    def __getslice__(self, *args):
        """__getslice__(stl_vector_owlrigid self, std::vector< OWLRigid >::difference_type i, std::vector< OWLRigid >::difference_type j) -> stl_vector_owlrigid"""
        return _OWL.stl_vector_owlrigid___getslice__(self, *args)

    def __setslice__(self, *args):
        """
        __setslice__(stl_vector_owlrigid self, std::vector< OWLRigid >::difference_type i, std::vector< OWLRigid >::difference_type j, 
            stl_vector_owlrigid v=std::vector< OWLRigid,std::allocator< OWLRigid > >())
        __setslice__(stl_vector_owlrigid self, std::vector< OWLRigid >::difference_type i, std::vector< OWLRigid >::difference_type j)
        """
        return _OWL.stl_vector_owlrigid___setslice__(self, *args)

    def __delslice__(self, *args):
        """__delslice__(stl_vector_owlrigid self, std::vector< OWLRigid >::difference_type i, std::vector< OWLRigid >::difference_type j)"""
        return _OWL.stl_vector_owlrigid___delslice__(self, *args)

    def __delitem__(self, *args):
        """
        __delitem__(stl_vector_owlrigid self, std::vector< OWLRigid >::difference_type i)
        __delitem__(stl_vector_owlrigid self, PySliceObject * slice)
        """
        return _OWL.stl_vector_owlrigid___delitem__(self, *args)

    def __getitem__(self, *args):
        """
        __getitem__(stl_vector_owlrigid self, PySliceObject * slice) -> stl_vector_owlrigid
        __getitem__(stl_vector_owlrigid self, std::vector< OWLRigid >::difference_type i) -> OWLRigid
        """
        return _OWL.stl_vector_owlrigid___getitem__(self, *args)

    def __setitem__(self, *args):
        """
        __setitem__(stl_vector_owlrigid self, PySliceObject * slice, stl_vector_owlrigid v)
        __setitem__(stl_vector_owlrigid self, PySliceObject * slice)
        __setitem__(stl_vector_owlrigid self, std::vector< OWLRigid >::difference_type i, OWLRigid x)
        """
        return _OWL.stl_vector_owlrigid___setitem__(self, *args)

    def append(self, *args):
        """append(stl_vector_owlrigid self, OWLRigid x)"""
        return _OWL.stl_vector_owlrigid_append(self, *args)

    def empty(self):
        """empty(stl_vector_owlrigid self) -> bool"""
        return _OWL.stl_vector_owlrigid_empty(self)

    def size(self):
        """size(stl_vector_owlrigid self) -> std::vector< OWLRigid >::size_type"""
        return _OWL.stl_vector_owlrigid_size(self)

    def clear(self):
        """clear(stl_vector_owlrigid self)"""
        return _OWL.stl_vector_owlrigid_clear(self)

    def swap(self, *args):
        """swap(stl_vector_owlrigid self, stl_vector_owlrigid v)"""
        return _OWL.stl_vector_owlrigid_swap(self, *args)

    def get_allocator(self):
        """get_allocator(stl_vector_owlrigid self) -> std::vector< OWLRigid >::allocator_type"""
        return _OWL.stl_vector_owlrigid_get_allocator(self)

    def begin(self):
        """begin(stl_vector_owlrigid self) -> std::vector< OWLRigid >::iterator"""
        return _OWL.stl_vector_owlrigid_begin(self)

    def end(self):
        """end(stl_vector_owlrigid self) -> std::vector< OWLRigid >::iterator"""
        return _OWL.stl_vector_owlrigid_end(self)

    def rbegin(self):
        """rbegin(stl_vector_owlrigid self) -> std::vector< OWLRigid >::reverse_iterator"""
        return _OWL.stl_vector_owlrigid_rbegin(self)

    def rend(self):
        """rend(stl_vector_owlrigid self) -> std::vector< OWLRigid >::reverse_iterator"""
        return _OWL.stl_vector_owlrigid_rend(self)

    def pop_back(self):
        """pop_back(stl_vector_owlrigid self)"""
        return _OWL.stl_vector_owlrigid_pop_back(self)

    def erase(self, *args):
        """
        erase(stl_vector_owlrigid self, std::vector< OWLRigid >::iterator pos) -> std::vector< OWLRigid >::iterator
        erase(stl_vector_owlrigid self, std::vector< OWLRigid >::iterator first, std::vector< OWLRigid >::iterator last) -> std::vector< OWLRigid >::iterator
        """
        return _OWL.stl_vector_owlrigid_erase(self, *args)

    def __init__(self, *args): 
        """
        __init__(std::vector<(OWLRigid)> self) -> stl_vector_owlrigid
        __init__(std::vector<(OWLRigid)> self, stl_vector_owlrigid arg2) -> stl_vector_owlrigid
        __init__(std::vector<(OWLRigid)> self, std::vector< OWLRigid >::size_type size) -> stl_vector_owlrigid
        __init__(std::vector<(OWLRigid)> self, std::vector< OWLRigid >::size_type size, OWLRigid value) -> stl_vector_owlrigid
        """
        this = _OWL.new_stl_vector_owlrigid(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args):
        """push_back(stl_vector_owlrigid self, OWLRigid x)"""
        return _OWL.stl_vector_owlrigid_push_back(self, *args)

    def front(self):
        """front(stl_vector_owlrigid self) -> OWLRigid"""
        return _OWL.stl_vector_owlrigid_front(self)

    def back(self):
        """back(stl_vector_owlrigid self) -> OWLRigid"""
        return _OWL.stl_vector_owlrigid_back(self)

    def assign(self, *args):
        """assign(stl_vector_owlrigid self, std::vector< OWLRigid >::size_type n, OWLRigid x)"""
        return _OWL.stl_vector_owlrigid_assign(self, *args)

    def resize(self, *args):
        """
        resize(stl_vector_owlrigid self, std::vector< OWLRigid >::size_type new_size)
        resize(stl_vector_owlrigid self, std::vector< OWLRigid >::size_type new_size, OWLRigid x)
        """
        return _OWL.stl_vector_owlrigid_resize(self, *args)

    def insert(self, *args):
        """
        insert(stl_vector_owlrigid self, std::vector< OWLRigid >::iterator pos, OWLRigid x) -> std::vector< OWLRigid >::iterator
        insert(stl_vector_owlrigid self, std::vector< OWLRigid >::iterator pos, std::vector< OWLRigid >::size_type n, OWLRigid x)
        """
        return _OWL.stl_vector_owlrigid_insert(self, *args)

    def reserve(self, *args):
        """reserve(stl_vector_owlrigid self, std::vector< OWLRigid >::size_type n)"""
        return _OWL.stl_vector_owlrigid_reserve(self, *args)

    def capacity(self):
        """capacity(stl_vector_owlrigid self) -> std::vector< OWLRigid >::size_type"""
...
class stl_vector_owlcamera(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self):
        """iterator(stl_vector_owlcamera self) -> SwigPyIterator"""
        return _OWL.stl_vector_owlcamera_iterator(self)

    def __iter__(self): return self.iterator()
    def __nonzero__(self):
        """__nonzero__(stl_vector_owlcamera self) -> bool"""
        return _OWL.stl_vector_owlcamera___nonzero__(self)

    def __bool__(self):
        """__bool__(stl_vector_owlcamera self) -> bool"""
        return _OWL.stl_vector_owlcamera___bool__(self)

    def __len__(self):
        """__len__(stl_vector_owlcamera self) -> std::vector< OWLCamera >::size_type"""
        return _OWL.stl_vector_owlcamera___len__(self)

    def pop(self):
        """pop(stl_vector_owlcamera self) -> OWLCamera"""
        return _OWL.stl_vector_owlcamera_pop(self)

    def __getslice__(self, *args):
        """__getslice__(stl_vector_owlcamera self, std::vector< OWLCamera >::difference_type i, std::vector< OWLCamera >::difference_type j) -> stl_vector_owlcamera"""
        return _OWL.stl_vector_owlcamera___getslice__(self, *args)

    def __setslice__(self, *args):
        """
        __setslice__(stl_vector_owlcamera self, std::vector< OWLCamera >::difference_type i, std::vector< OWLCamera >::difference_type j, 
            stl_vector_owlcamera v=std::vector< OWLCamera,std::allocator< OWLCamera > >())
        __setslice__(stl_vector_owlcamera self, std::vector< OWLCamera >::difference_type i, std::vector< OWLCamera >::difference_type j)
        """
        return _OWL.stl_vector_owlcamera___setslice__(self, *args)

    def __delslice__(self, *args):
        """__delslice__(stl_vector_owlcamera self, std::vector< OWLCamera >::difference_type i, std::vector< OWLCamera >::difference_type j)"""
        return _OWL.stl_vector_owlcamera___delslice__(self, *args)

    def __delitem__(self, *args):
        """
        __delitem__(stl_vector_owlcamera self, std::vector< OWLCamera >::difference_type i)
        __delitem__(stl_vector_owlcamera self, PySliceObject * slice)
        """
        return _OWL.stl_vector_owlcamera___delitem__(self, *args)

    def __getitem__(self, *args):
        """
        __getitem__(stl_vector_owlcamera self, PySliceObject * slice) -> stl_vector_owlcamera
        __getitem__(stl_vector_owlcamera self, std::vector< OWLCamera >::difference_type i) -> OWLCamera
        """
        return _OWL.stl_vector_owlcamera___getitem__(self, *args)

    def __setitem__(self, *args):
        """
        __setitem__(stl_vector_owlcamera self, PySliceObject * slice, stl_vector_owlcamera v)
        __setitem__(stl_vector_owlcamera self, PySliceObject * slice)
        __setitem__(stl_vector_owlcamera self, std::vector< OWLCamera >::difference_type i, OWLCamera x)
        """
        return _OWL.stl_vector_owlcamera___setitem__(self, *args)

    def append(self, *args):
        """append(stl_vector_owlcamera self, OWLCamera x)"""
        return _OWL.stl_vector_owlcamera_append(self, *args)

    def empty(self):
        """empty(stl_vector_owlcamera self) -> bool"""
        return _OWL.stl_vector_owlcamera_empty(self)

    def size(self):
        """size(stl_vector_owlcamera self) -> std::vector< OWLCamera >::size_type"""
        return _OWL.stl_vector_owlcamera_size(self)

    def clear(self):
        """clear(stl_vector_owlcamera self)"""
        return _OWL.stl_vector_owlcamera_clear(self)

    def swap(self, *args):
        """swap(stl_vector_owlcamera self, stl_vector_owlcamera v)"""
        return _OWL.stl_vector_owlcamera_swap(self, *args)

    def get_allocator(self):
        """get_allocator(stl_vector_owlcamera self) -> std::vector< OWLCamera >::allocator_type"""
        return _OWL.stl_vector_owlcamera_get_allocator(self)

    def begin(self):
        """begin(stl_vector_owlcamera self) -> std::vector< OWLCamera >::iterator"""
        return _OWL.stl_vector_owlcamera_begin(self)

    def end(self):
        """end(stl_vector_owlcamera self) -> std::vector< OWLCamera >::iterator"""
        return _OWL.stl_vector_owlcamera_end(self)

    def rbegin(self):
        """rbegin(stl_vector_owlcamera self) -> std::vector< OWLCamera >::reverse_iterator"""
        return _OWL.stl_vector_owlcamera_rbegin(self)

    def rend(self):
        """rend(stl_vector_owlcamera self) -> std::vector< OWLCamera >::reverse_iterator"""
        return _OWL.stl_vector_owlcamera_rend(self)

    def pop_back(self):
        """pop_back(stl_vector_owlcamera self)"""
        return _OWL.stl_vector_owlcamera_pop_back(self)

    def erase(self, *args):
        """
        erase(stl_vector_owlcamera self, std::vector< OWLCamera >::iterator pos) -> std::vector< OWLCamera >::iterator
        erase(stl_vector_owlcamera self, std::vector< OWLCamera >::iterator first, std::vector< OWLCamera >::iterator last) -> std::vector< OWLCamera >::iterator
        """
        return _OWL.stl_vector_owlcamera_erase(self, *args)

    def __init__(self, *args): 
        """
        __init__(std::vector<(OWLCamera)> self) -> stl_vector_owlcamera
        __init__(std::vector<(OWLCamera)> self, stl_vector_owlcamera arg2) -> stl_vector_owlcamera
        __init__(std::vector<(OWLCamera)> self, std::vector< OWLCamera >::size_type size) -> stl_vector_owlcamera
        __init__(std::vector<(OWLCamera)> self, std::vector< OWLCamera >::size_type size, OWLCamera value) -> stl_vector_owlcamera
        """
        this = _OWL.new_stl_vector_owlcamera(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args):
        """push_back(stl_vector_owlcamera self, OWLCamera x)"""
        return _OWL.stl_vector_owlcamera_push_back(self, *args)

    def front(self):
        """front(stl_vector_owlcamera self) -> OWLCamera"""
        return _OWL.stl_vector_owlcamera_front(self)

    def back(self):
        """back(stl_vector_owlcamera self) -> OWLCamera"""
        return _OWL.stl_vector_owlcamera_back(self)

    def assign(self, *args):
        """assign(stl_vector_owlcamera self, std::vector< OWLCamera >::size_type n, OWLCamera x)"""
        return _OWL.stl_vector_owlcamera_assign(self, *args)

    def resize(self, *args):
        """
        resize(stl_vector_owlcamera self, std::vector< OWLCamera >::size_type new_size)
        resize(stl_vector_owlcamera self, std::vector< OWLCamera >::size_type new_size, OWLCamera x)
        """
        return _OWL.stl_vector_owlcamera_resize(self, *args)

    def insert(self, *args):
        """
        insert(stl_vector_owlcamera self, std::vector< OWLCamera >::iterator pos, OWLCamera x) -> std::vector< OWLCamera >::iterator
        insert(stl_vector_owlcamera self, std::vector< OWLCamera >::iterator pos, std::vector< OWLCamera >::size_type n, OWLCamera x)
        """
        return _OWL.stl_vector_owlcamera_insert(self, *args)

    def reserve(self, *args):
        """reserve(stl_vector_owlcamera self, std::vector< OWLCamera >::size_type n)"""
        return _OWL.stl_vector_owlcamera_reserve(self, *args)

    def capacity(self):
        """capacity(stl_vector_owlcamera self) -> std::vector< OWLCamera >::size_type"""
...
class BaseData(_object):
    ...
    def __init__(self): 
        """__init__(BaseData self) -> BaseData"""
        this = _OWL.new_BaseData()
        try: self.this.append(this)
        except: self.this = this
    def Print(self, *args):
        """Print(BaseData self, BaseData::Data const & base, std::ostream & out) -> int"""
...
class OWLMarker(_object):
    ...
    def __init__(self): 
        """__init__(OWLMarker self) -> OWLMarker"""
...
class OWLRigid(_object):
    ...
    def __init__(self): 
        """__init__(OWLRigid self) -> OWLRigid"""
...
class OWLCamera(_object):
    ...
    def __init__(self): 
        """__init__(OWLCamera self) -> OWLCamera"""
...
class OWLEvent(_object):
    ...
    def __init__(self): 
        """__init__(OWLEvent self) -> OWLEvent"""
